...
### Fixed
- **Counter Overlay Hosting**: Shop counter image now uses absolute Supabase Storage URL in database, fixing missing counter on external host sites like CARFIX
